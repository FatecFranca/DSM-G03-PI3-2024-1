...
const Signup = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 w-full text-xs">
      <div className="w-3/4 m-5 flex rounded-lg shadow-lg">
        ...
        <div className="w-2/3 bg-white bg-slate-200	 p-8 pt-0 shadow-2xl  relative">
          <div className="text-center d-flex justify-center gap-3 h-full">
            <div className="flex justify-center items-center" style={{ height: '97%' }}>
